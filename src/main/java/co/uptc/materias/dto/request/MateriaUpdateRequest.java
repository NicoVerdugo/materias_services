...
/**
 * DTO para la actualización de una Materia.
 */
@Schema(description = "Datos requeridos para actualizar una materia")
public record MateriaUpdateRequest(

        @Schema(description = "Nombre de la materia", example = "Sistemas Distribuidos Avanzados")
        @NotBlank(message = "El nombre es obligatorio")
        @Size(max = 150, message = "El nombre no debe exceder 150 caracteres")
        String nombre,

        @Schema(description = "Descripción de la materia", example = "Estudio avanzado de sistemas de cómputo distribuido")
